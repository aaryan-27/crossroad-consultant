...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Y3 REALTY — a decade of trusted, data-backed real estate advisory across Gurgaon, New Gurgaon & Dwarka Expressway. Rs.1000 Cr+ in deals, 5000+ happy clients.",
