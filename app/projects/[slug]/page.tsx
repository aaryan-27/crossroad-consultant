...
export async function generateMetadata({
  ...
  return {
    ...
    description: `${project.name}: ${project.type} in ${project.location}. ${project.about.slice(0, 120)}… Price from ${formatINR(project.priceFrom)}. Book a site visit with Evergreen Real Estate.`,
